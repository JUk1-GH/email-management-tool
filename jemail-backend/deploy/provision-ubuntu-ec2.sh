...
JEMAIL_TURNSTILE_SITE_KEY=${JEMAIL_TURNSTILE_SITE_KEY:-}
JEMAIL_TURNSTILE_SECRET_KEY=${JEMAIL_TURNSTILE_SECRET_KEY:-}
JEMAIL_TURNSTILE_VERIFY_URL=${JEMAIL_TURNSTILE_VERIFY_URL:-https://challenges.cloudflare.com/turnstile/v0/siteverify}
PORT=$PORT
EOF
